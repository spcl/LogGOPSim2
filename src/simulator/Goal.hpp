...
class Goal {
    ...
    public:
        ...
        goalop_t Gem5Calc(uint32_t src,uint32_t binid,uint64_t size, uint8_t cpu, uint8_t nic) {
        ...
        goalop_t Put(uint32_t src, uint32_t oct, uint32_t dest, uint64_t size, uint32_t tag, uint8_t cpu, uint8_t nic, uint64_t arg1, uint64_t arg2, uint64_t arg3, uint64_t arg4){
            Node* n = graph.addNode();
        ...
        goalop_t Append(uint32_t src, uint32_t oct, uint32_t allowed, uint64_t size, uint32_t tag, char options, uint8_t cpu, uint8_t nic, uint32_t hh, uint32_t ph, uint32_t ch, uint32_t mem,uint64_t arg1, uint64_t arg2, uint64_t arg3, uint64_t arg4){
            Node* n = graph.addNode();
        ...
        goalop_t tAppend(uint32_t src, uint32_t oct, uint32_t allowed, uint64_t size, uint32_t tag, char options, uint8_t cpu, uint8_t nic, uint32_t ct, uint64_t threshold, uint32_t hh, uint32_t ph, uint32_t ch, uint32_t mem, uint64_t arg1, uint64_t arg2, uint64_t arg3, uint64_t arg4){
            Node*n = Append(src, oct, allowed, size, tag, options, cpu, nic, hh, ph, ch, mem,arg1, arg2, arg3, arg4);
        ...
        goalop_t tPut(uint32_t src, uint32_t oct, uint32_t dest, uint64_t size, uint32_t tag, uint8_t cpu, uint8_t nic, uint64_t arg1, uint64_t arg2, uint64_t arg3, uint64_t arg4, uint32_t ct, uint64_t threshold){
