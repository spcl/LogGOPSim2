...
const char *gengetopt_args_info_usage = "Usage: schedgen [OPTIONS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "      --traces-copyemu=INT   emulate copy time for message matching (0-100%)\n                               (default=`0')",
...
const char *cmdline_parser_ptrn_values[] = {"binomialtreereduce", "binarytreebcast", "binomialtreebcast", "nwaydissemination", "pipelinedring", "pipelinedringdep", "doublering", "gather", "scatter", "linbarrier", "trace", "dissemination", "random_bisect", "random_bisect_fd_sym", "linear_alltoall", 0}; /*< Possible values for ptrn. */
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->traces_copyemu_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->traces_copyemu_arg = 0;
  args_info->traces_copyemu_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->traces_copyemu_help = gengetopt_args_info_help[16] ;
  args_info->traces_extr_help = gengetopt_args_info_help[17] ;
  args_info->traces_print_help = gengetopt_args_info_help[18] ;
  args_info->traces_nop2p_help = gengetopt_args_info_help[19] ;
  args_info->traces_nocolls_help = gengetopt_args_info_help[20] ;
  args_info->traces_nbcify_help = gengetopt_args_info_help[21] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->traces_copyemu_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->traces_copyemu_given)
    write_into_file(outfile, "traces-copyemu", args_info->traces_copyemu_orig, 0);
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          /* emulate copy time for message matching (0-100%).  */
          else if (strcmp (long_options[option_index].name, "traces-copyemu") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->traces_copyemu_arg), 
                 &(args_info->traces_copyemu_orig), &(args_info->traces_copyemu_given),
                &(local_args_info.traces_copyemu_given), optarg, 0, "0", ARG_INT,
                check_ambiguity, override, 0, 0,
                "traces-copyemu", '-',
                additional_error))
              goto failure;
